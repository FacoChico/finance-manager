...
Данные хранятся в памяти и сохраняются в JSON-файлы в папке по умолчанию `data/`.
...
- Папка для хранения может быть переназначена через переменную `app.data-dir`;
