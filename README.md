...
- `import <path/to/wallet-file.json>` — импорт кошелька из json-файла в 'data/<login>.json' c присвоением кошельк атекущему пользователю;
...
- Файлы кошельков имеют вид `data/<login>.json`;
